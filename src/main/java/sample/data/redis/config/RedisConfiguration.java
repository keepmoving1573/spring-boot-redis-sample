package sample.data.redis.config;
...
public class RedisConfiguration extends AbstractConfiguration {
    ...
    public RedisConnectionFactory jedisConnectionFactory() {
        ...
        jedisConnectionFactory.setHostName(resolver.getProperty("host"));
        jedisConnectionFactory.setPort(Integer.parseInt(resolver.getProperty("port")));
    ...
    public RedisConnectionFactory jedisConnectionFactory() {
        ...
        logger.warn("------------sentinel------------" + JSON.toJSONString(sentinelConfig));
